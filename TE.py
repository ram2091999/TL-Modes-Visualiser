...
def handleTE(st,modes=[0,0],type_of_waveguide="Rectangular",A=10,B=5,R=5):
    if type_of_waveguide == "Rectangular":
        st.subheader("Dominant Mode : TE-10 Mode")
        ...
        st.write(pd.DataFrame({
           ...
           'Value': [par.Kc(),par.Fc(), par.beta_g(),par.v_G(),par.Z_in(),par.Z_G_TE(),par.lambda_G(), par.lambda_C()],
           'Unit':["1/m", "Hz", "1/m", "m/s", "Ohm", "Ohm", "m", "m"]
       }))
          

    else:
        st.subheader("Dominant Mode : TE-11 Mode")
        ...
        st.write(pd.DataFrame({
           'Parameter': ["Kc", "Fc", "Beta-g", "Vg","Zin","Zg","lambda-g", "lambda-C"],
           'Value': [par.Kc_TE(),par.Fc_TE(), par.beta_g_TE(),par.v_G_TE(),par.Z_in(),par.Z_G_TE(),par.lambda_G_TE(), par.lambda_C_TE()],
           'Unit':["1/m", "Hz", "1/m", "m/s", "Ohm", "Ohm", "m", "m"]
       }))
